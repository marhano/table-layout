...
var files = [
  ...
  "src/modules/GridRooms.js", // room creation — must come before GridLayers
  "src/modules/GridLayers.js", // layer switcher + toolbar layer controls
  "src/TableLayout.js",
];
...
var mvcDir =
  "C:/Users/marjan.carullo/source/repos/OmniBusiness/OmniBusiness/wwwroot/libs/table-layout/";
try {
  fs.mkdirSync(mvcDir, { recursive: true });
  fs.copyFileSync(
    "./dist/table-layout.js",
    path.join(mvcDir, "table-layout.js"),
  );
  fs.copyFileSync(
    "./dist/table-layout.css",
    path.join(mvcDir, "table-layout.css"),
  );
